...
To use these stylesheets, rename the files and mma_intra with the name of your theme.
...
mma_intra-alpha-default-narrow.css  
...
mma_intra-alpha-default-normal.css
...
mma_intra-alpha-default-wide.css
